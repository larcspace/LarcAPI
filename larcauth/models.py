...
class academicyear (models.Model):
    ...
    current_term_number = models.SmallIntegerField(
        ...
        default = TERM_NONE,)
    auto_calc = models.BooleanField (default=True) # pour le déchancehement des triggers dans changement de valeur @Aout 2020
    debug_mode = models.BooleanField (default=True) # pour le déchancehement des triggers dans changement de valeur @Aout 2020
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
...
class AECUser(AbstractUser):
    ...
    # Modification 2020-10-16 : Un seul compte d'accès possible aux informations des élèves
    # Compte arc-en-ciel.
    fk_parent = models.ForeignKey('parentutor', on_delete=models.PROTECT,null=True,blank=True)
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
...
class learnerDP_has_termsubjectDP(learner_has_termsubject):
    ...
    ei_observation = models.CharField(null=True,max_length=2000)
...
class evaluation(models.Model):
    ...
    # Correction 26/07/2020
    # Mise à 0 (False) des indicateur de choix de critère dans chaque évaluation
    crit_a = models.NullBooleanField(default=0)
    aspect_a1 = models.NullBooleanField(default=False)
    aspect_a2 = models.NullBooleanField(default=False)
    aspect_a3 = models.NullBooleanField(default=False)
    aspect_a4 = models.NullBooleanField(default=False)
    aspect_a5 = models.NullBooleanField(default=False)
    aspect_a6 = models.NullBooleanField(default=False)
    aspect_a7 = models.NullBooleanField(default=False)
    crit_b = models.NullBooleanField(default=0)
    aspect_b1 = models.NullBooleanField(default=False)
    aspect_b2 = models.NullBooleanField(default=False)
    aspect_b3 = models.NullBooleanField(default=False)
    aspect_b4 = models.NullBooleanField(default=False)
    aspect_b5 = models.NullBooleanField(default=False)
    aspect_b6 = models.NullBooleanField(default=False)
    aspect_b7 = models.NullBooleanField(default=False)
    crit_c = models.NullBooleanField(default=0)
    aspect_c1 = models.NullBooleanField(default=False)
    aspect_c2 = models.NullBooleanField(default=False)
    aspect_c3 = models.NullBooleanField(default=False)
    aspect_c4 = models.NullBooleanField(default=False)
    aspect_c5 = models.NullBooleanField(default=False)
    aspect_c6 = models.NullBooleanField(default=False)
    aspect_c7 = models.NullBooleanField(default=False)
    crit_d = models.NullBooleanField(default=0)
    aspect_d1 = models.NullBooleanField(default=False)
    aspect_d2 = models.NullBooleanField(default=False)
    aspect_d3 = models.NullBooleanField(default=False)
    aspect_d4 = models.NullBooleanField(default=False)
    aspect_d5 = models.NullBooleanField(default=False)
    aspect_d6 = models.NullBooleanField(default=False)
    aspect_d7 = models.NullBooleanField(default=False)
    crit_e = models.NullBooleanField(default=0)
    aspect_e1 = models.NullBooleanField(default=False)
    aspect_e2 = models.NullBooleanField(default=False)
    aspect_e3 = models.NullBooleanField(default=False)
    aspect_e4 = models.NullBooleanField(default=False)
    aspect_e5 = models.NullBooleanField(default=False)
    aspect_e6 = models.NullBooleanField(default=False)
    aspect_e7 = models.NullBooleanField(default=False)
    crit_F = models.NullBooleanField(default=False)
    aspect_f1 = models.NullBooleanField(default=False)
    aspect_f2 = models.NullBooleanField(default=False)
    aspect_f3 = models.NullBooleanField(default=False)
    aspect_f4 = models.NullBooleanField(default=False)
    aspect_f5 = models.NullBooleanField(default=False)
    aspect_f6 = models.NullBooleanField(default=False)
    aspect_f7 = models.NullBooleanField(default=False)
    ...
    average_a = models.FloatField(null=True)
    average_b = models.FloatField(null=True)
    average_c = models.FloatField(null=True)
    average_d = models.FloatField(null=True)
    average_e = models.FloatField(null=True)
    average_f = models.FloatField(null=True)
    # Standard deviation
    stddev = models.FloatField(null=True)
    stddev_a = models.FloatField(null=True)
    stddev_b = models.FloatField(null=True)
    stddev_c = models.FloatField(null=True)
    stddev_d = models.FloatField(null=True)
    stddev_e = models.FloatField(null=True)
    stddev_f = models.FloatField(null=True)
    # Maximum
    maxim = models.FloatField(null=True)
    maxim_a = models.SmallIntegerField(null=True)
    maxim_b = models.SmallIntegerField(null=True)
    maxim_c = models.SmallIntegerField(null=True)
    maxim_d = models.SmallIntegerField(null=True)
    maxim_e = models.SmallIntegerField(null=True)
    maxim_f = models.SmallIntegerField(null=True)
    # Minimum
    minim = models.FloatField(null=True)
    minim_a = models.SmallIntegerField(null=True)
    minim_b = models.SmallIntegerField(null=True)
    minim_c = models.SmallIntegerField(null=True)
    minim_d = models.SmallIntegerField(null=True)
    minim_e = models.SmallIntegerField(null=True)
    minim_f = models.SmallIntegerField(null=True)
    # Nb students marks superor or equal to the normal average
    nb_mark = models.SmallIntegerField(null=True)
    nb_mark_a = models.SmallIntegerField(null=True)
    nb_mark_b = models.SmallIntegerField(null=True)
    nb_mark_c = models.SmallIntegerField(null=True)
    nb_mark_d = models.SmallIntegerField(null=True)
    nb_mark_e = models.SmallIntegerField(null=True)
    nb_mark_f = models.SmallIntegerField(null=True)

    #""" Ajout Aout 2020 - All grades in charcaters"""
    all_grades = models.CharField(max_length=300,null=True)
    all_grades_a = models.CharField(max_length=300, null=True)
    all_grades_b = models.CharField(max_length=300, null=True)
    all_grades_c = models.CharField(max_length=300, null=True)
    all_grades_d = models.CharField(max_length=300, null=True)
    all_grades_e = models.CharField(max_length=300, null=True)
    all_grades_f = models.CharField(max_length=300, null=True)

    fk_classroom_termsubject = models.ForeignKey('classroom_termsubject',on_delete = models.PROTECT)
    # Ajout classroom --> 31/10/2020 Pour serialiser la table avec recherche sur la classe
    fk_classroom = models.ForeignKey('classroom',on_delete = models.PROTECT, default=2221)
    fk_term = models.ForeignKey('term',on_delete = models.PROTECT, default=1)
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
...
class student_has_termsubjeval (models.Model):
    id_big = models.BigIntegerField(primary_key= True,null=False)
...
class table_log (models.Model):
    id_big =models.AutoField(primary_key=True)
    # created --> Date de création de l'objet
    created = models.DateTimeField(auto_now_add=True)
    log_message = models.CharField(max_length=500, null=True, blank=True)

    def __str__(self):
            return str(self.id_big)
...
class API_StudentDP_has_termsubjectDP(learner_has_termsubject):
    used = models.BooleanField(null=False,default=False) 
    date_updated = models.DateField(null=True,blank=True)
    i_studentid = models.IntegerField(null=True)
    i_subjectid = models.IntegerField(null=True)
    i_term = models.SmallIntegerField(null=True)
    s_name = models.CharField(null=True,max_length=72)
    s_firstname = models.CharField(null=True,max_length=72)
    s_pgm = models.CharField(null=True,max_length=4)
    s_classroom = models.CharField(null=True,max_length=7)
    s_grpm = models.CharField(null=True,max_length=44)
    s_matiere = models.CharField(null=True,max_length=72)
    s_teacher_name = models.CharField(null=True,max_length=72)
    s_teacher_Firstname = models.CharField(null=True,max_length=72)
    
    s_crit_a = models.CharField(null=True,max_length=72)
    s_crit_b = models.CharField(null=True,max_length=72)
    s_crit_c = models.CharField(null=True,max_length=72)
    s_crit_d = models.CharField(null=True,max_length=72)
    s_crit_e = models.CharField(null=True,max_length=72)
    s_crit_f = models.CharField(null=True,max_length=72)

    s_term = models.CharField(null=True,max_length=2)
    f01_observation = models.CharField(null=True,max_length=360)
    f02_observation = models.CharField(null=True,max_length=360)
    f03_observation = models.CharField(null=True,max_length=360)
    f04_observation = models.CharField(null=True,max_length=360)
    ...
    def __str__(self):
        return (self.NAME + '-' + self.firstname + '-' + self.s_matiere + self.s_term)
    """
    # Population
    # The table is populate with a script with default value
    # according to the config table
